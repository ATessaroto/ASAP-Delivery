...
<html lang="pt-br">
  ...
  <body>
    ...
    <main>
            <div class="col-info">
              <img id="logo_restaurante" src="..//4.Restaurantes/img/Logo-Saudaveis.png" alt="">
              <p id="nome_logo">Saudaveis</p>
            </div>
            <div class="col1">
              ...
              <div class="card sacola-add" data-name="Marmita Saudavel">
                <div class="img_container">
                  <img class="card-image" src="../4.Restaurantes/img/Marmita-saudavel.png">
                </div>
                <div class="card-content">
                  <p>Marmita Saudavel </p>
                </div>
