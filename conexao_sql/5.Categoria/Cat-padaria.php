...
<html lang="pt-br">
  ...
  <body>
    ...
    <main>
            <div class="col-info">
              <img id="logo_restaurante" src="..//4.Restaurantes/img/Logo-Padaria.png" alt="">
              <p id="nome_logo">Categoria: Padaria</p>
            </div>
            <div class="col1">
             
              <div class="card sacola-add" data-name="Croissant">
              ...
              <div class="card sacola-add" data-name="Pão de Queijo">
