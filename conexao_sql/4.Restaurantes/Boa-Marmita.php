...
<html lang="pt-br">
  ...
  <body>
    ...
    <main>
            <div class="col-info">
              <img id="logo_restaurante" src="..//4.Restaurantes/img/Boa Marmita.jpeg" alt="">
              <p id="nome_logo"> Restaurante Boa Marmita</p>
            </div>
            <div class="col1">
            
              <div class="card sacola-add" id="4" data-name="Varias Marmitas">
              ...
              <div class="card sacola-add" id="5" data-name="Marmita fit(Frango)">
              ...
              <div class="card sacola-add" id="6" data-name="Suco Natural">
              ...
              <div class="card sacola-add" id="7" data-name="Sucos">
