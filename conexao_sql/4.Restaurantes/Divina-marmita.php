...
<html lang="pt-br">
  ...
  <body>
    ...
    <main>  
            <div class="col-info">
              <img id="logo_restaurante" src="..//4.Restaurantes/img/Marmitex_logo.png" alt="">
              <p id="nome_logo">Restaurante Divina Marmita</p>
            </div>
            <div class="col1">
            
              <div class="card sacola-add" id="15" data-name="Marmita Simples">
              <a class="card_click" href="../0.Global/add_item_sacola.php?id=15">
              ...
              <div class="card sacola-add" id="16" data-name="Marmita Top">
              <a class="card_click" href="../0.Global/add_item_sacola.php?id=16">
                <div class="img_container">
              ...
              <div class="card sacola-add" id="17" data-name="Refris">
              <a class="card_click" href="../0.Global/add_item_sacola.php?id=17">
                <div class="img_container">
