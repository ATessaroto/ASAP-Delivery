  ...
  <body>
    ...
    <main>
            <div class="col-info">
              ...
              <img id="logo_restaurante" src="..//4.Restaurantes/img/Pizzaria.png" alt="">
              <p id="nome_logo">Pizzaria Pizza Master</p>
            </div>
            <div class="col1">
              
              <div class="card sacola-add" id="1" data-name="Pizza Portuguesa">
              ...
              <div class="card sacola-add" id="2" data-name="Pizza Frango Cremosa">
              ...
              <div class="card sacola-add" id="3" data-name="Pizza Calabresa">
